      ...
      00818F CD 82 8B         [ 4]  305 	call	_init_milis
                           000051   306 	Smain$setup$50 ==.
                                    307 ;	./src/main.c: 16: GPIO_Init(GPIOE, GPIO_PIN_3,GPIO_MODE_IN_FL_NO_IT); // nastavíme PE3 jako vstup (fototranzistor)
                                    308 ; genIPush
      ...
      00819D 5B 04            [ 2]  321 	addw	sp, #4
                           ...
                           00005E   323 	Smain$setup$56 ==.
                                    324 ;	./src/main.c: 17: GPIO_Init(GPIOE, GPIO_PIN_4,GPIO_MODE_IN_FL_NO_IT); // nastavíme PE4 jako vstup (tlačítko)
                                    325 ; genIPush
      ...
      0081AD 52 27            [ 2]  359 	sub	sp, #39
                           ...
                           00006E   361 	Smain$main$68 ==.
                                    362 ;	./src/main.c: 24: uint32_t time = 0; //inicializace proměnných
                                    363 ; genAssign
      ...
      0081BD                        386 00114$:
                           ...
                           00007C   388 	Smain$main$75 ==.
                                    389 ;	./src/main.c: 34: if(GPIO_ReadInputPin(GPIOE,GPIO_PIN_3)==RESET){ // kontrolujeme zda je senzor laseru sepnutý
                                    390 ; genIPush
      ...
      0081E0                        440 00105$:
                           00009F   441 	Smain$main$90 ==.
                                    442 ;	./src/main.c: 44: if(GPIO_ReadInputPin(GPIOE,GPIO_PIN_4)==RESET){ // kontrolujeme zda je tlačítko stisknuté
                                    443 ; genIPush
